 ...
 * @Created by CBX
 */
public class DwDatabaseManager {
  ...
  static {
    try {
      ...
      dataSource.setJdbcUrl("jdbc:mysql://localhost:3306/cdp_dw?useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true&useSSL=false");
